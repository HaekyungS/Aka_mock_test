...
export const problems: Array<problems> = [
  ...
  {
    number: "두번째",
    problem: "2023년 04월 02일 류님 친구 만들기 컨텐츠에서 류님이 소개받은 친구가 아닌 분은?",
    ex: ["남연희님", "푸린님", "망고님", "채리리님"],
  },
  {
    number: "세번째",
    problem:
      "2023년 04월 30일, 류 vs 잭 지식결투 당시, 류님이 전화 찬스로 하루나비님께 전화를 걸었던 문제의 답은?",
  ...
  },
  {
    number: "열한번째",
    problem:
      "2023년 10월 15일 반캠 술방 중 뮤직포스 멤버들에게 전화를 걸었다. 다음 중 류님의 전화를 받지 않은 멤버는?",
    ex: ["베르님", "하로님", "헤르님", "이현님"],
  },
];
